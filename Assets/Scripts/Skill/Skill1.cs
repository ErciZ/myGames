...
public class Skill1 : DataType
{
    ...
    //[XmlArray("activeskill")]
    //public activeskill activeskill;
    //public activeskill[] activeskill;
    //public static Dictionary<string, activeskill> activeskill_dic = new Dictionary<string, activeskill>();

    public Skill1(int _id, string _myName)
    {
        id = _id;
        name = _myName;
    }
    ...
    public void Output()
    {
        Debug.Log(id);
        Debug.Log(name);
        //Debug.Log(activeskill[0].skillName);
